...
- Directly converts sunlight into heat for drying
- Highly efficient and reduces electrical dependency
...
4. Data is sent to the Dhup app via Bluetooth/WiFi.
...
- Real-time monitoring via Dhup app
